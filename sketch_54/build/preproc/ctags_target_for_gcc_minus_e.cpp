...
void red(){
    digitalWrite(RED, 0x1), delay(hightTime), digitalWrite(RED, 0x0), delay(lowTime);
}


void green(){
    digitalWrite(GRE, 0x1), delay(hightTime), digitalWrite(GRE, 0x0), delay(lowTime);
}

void white(){
    digitalWrite(WHI, 0x1), delay(hightTime), digitalWrite(WHI, 0x0), delay(lowTime);
}
